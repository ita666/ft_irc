...
#define ERR_ALREADYREGISTRED(nickname) (std::string(":") + SERVER_NAME + " 462 " + nickname + RED + " :Already registred\r\n" + RESET)
...
#define ERR_UMODEUNKNOWNFLAG(nickname) (string(":") + SERVER_NAME + " 501 " + nickname + RED + " :Unknown MODE flag" + "\r\n" + RESET)
#define ERR_USERSDONTMATCH(nickname) (std::string(":") + SERVER_NAME + " 502 " + nickname + RED +" :Cant change mode for other users\r\n" + RESET)
